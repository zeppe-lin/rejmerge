...
For each rejected file found in F<@LIBDIR@/rejmerge/rejected/>,
B<rejmerge> will display difference between installed version and the
rejected version.
...
=item F<@LIBDIR@/rejmerge/rejected/>

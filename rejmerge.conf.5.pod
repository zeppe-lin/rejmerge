# rejmerge.conf.5.pod - documentation for rejmerge.conf(5) manual page
...
=head1 EXAMPLE
  ...
  # Use vim(1) as editor instead of the default vi(1), unless EDITOR
  # was not set from command-line, like: EDITOR=emacs rejmerge.
  EDITOR="${EDITOR:-/usr/bin/vim}"

  # Use less(1) as pager instead of the default more(1), unless PAGER
  # was not set from command-line.  -R option is required if diffs

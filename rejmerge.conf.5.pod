...
B<@SYSCONFDIR@/rejmerge.conf>

=head1 DESCRIPTION

This manual page describes the format of the F<rejmerge.conf> file.
This file can be used to alter the way
L<rejmerge(8)|https://zeppe-lin.github.io/rejmerge.8.html> displays
file differences and performs file merges.  Changing the default
...
This variable defines the pager used in C<diff> and C<merge>
operations.
...
=head1 EXAMPLE
  ...
  #
  # @SYSCONFDIR@/rejmerge.conf: rejmerge(8) configuration
  #
...
=item F<@SYSCONFDIR@/rejmerge.conf>
